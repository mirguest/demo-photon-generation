#ifndef GPUParametersManager_hh
#define GPUParametersManager_hh

#include "GPUOpEngine.hh"

template<typename OpEngine>
struct DummyGpuParametersManager {
    ...
    DummyGpuParametersManager() {

    }
};

typedef DummyGpuParametersManager<DummyGpuOpEngine> DummyGpuParametersManager_t;
